...
# Locate Chromium browser (Edge / Chrome)
browser_candidates = [
...
img_a_src = brain_dir / "brand_new_skyline_power_woman_1787193355401.jpg"
img_b_src = brain_dir / "brand_new_nanyou_vip_consultation_1787193433615.jpg"
img_c_src = brain_dir / "brand_new_yam_tannin_silk_macro_1787193371180.jpg"

img_a_dst = out_dir / "xiangyun_power_female_skyline_4K.jpg"
img_b_dst = out_dir / "xiangyun_nanyou_consultation_table_4K.jpg"
img_c_dst = out_dir / "xiangyun_yam_silk_macro_4K.jpg"
...
print("Images copied to 8-21 cover directory.")

# 2. HTML Template generator for 8-21 covers
...
options = [
    ("xiangyun_power_female_skyline_4K.jpg", "封面图A - 现代高定智性大女主版", "cover23_option_A_1344x924", "72% center"),
    ("xiangyun_nanyou_consultation_table_4K.jpg", "封面图B - 权威品质鉴真与品鉴台版", "cover23_option_B_1344x924", "center center"),
    ("xiangyun_yam_silk_macro_4K.jpg", "封面图C - 非遗古法溯源与重工丝绸版", "cover23_option_C_1344x924", "65% center")
]
...
print("All 8-21 covers rendered successfully in Ultra HD!")
